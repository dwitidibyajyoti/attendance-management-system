...
import { UserCircleIcon, HomeIcon, SunIcon , UsersIcon } from '@heroicons/react/outline';
                ...
                <div className='bg-white h-screen justify-between relative'>
                    ...
                    {role === 'admin' && (
                        <div className=' cursor-pointer'>
                            <ul className="list-none space-y-2">
                                <li className="flex flex-col h-8 hover:border-l-2 border-l border-transparent hover:border-blue-900 justify-center items-center w-full hover:bg-blue-50   hover:text-blue-600">
                                ...
                                <li className="flex flex-col h-8 hover:border-l-2 border-transparent hover:border-blue-900 justify-center items-center w-full hover:bg-blue-50 hover:text-blue-600">
                    ...
                    {role === 'hr' && (
                        <div className='text-blue-600 cursor-pointer'>
                            ...
                            <li className="flex flex-col h-8 hover:border-l-2 border-l border-transparent hover:border-blue-900 justify-center items-center w-full hover:bg-blue-50   hover:text-blue-600">
                                    <Link to="/attendance" className='flex text-gray-700 hover:text-blue-600 ml-5 w-full'>
                                        <HomeIcon className="h-5 w-5 mr-2 text-gray-700" />
                                        Attendance
                                    </Link>
                                </li>
                                <li className="flex flex-col h-8 hover:border-l-2 border-transparent hover:border-blue-900 justify-center items-center w-full hover:bg-blue-50 hover:text-blue-600">
                                    <Link to="/holidays" className='flex text-gray-700 hover:text-blue-600 ml-5 w-full'>
                                        <SunIcon className="h-5 w-5 mr-2 text-gray-700" />
                                        Holidays
                                    </Link>
                                </li>
                                <li className="flex flex-col h-8 hover:border-l-2 border-transparent hover:border-blue-900 justify-center items-center w-full hover:bg-blue-50 hover:text-blue-600">
