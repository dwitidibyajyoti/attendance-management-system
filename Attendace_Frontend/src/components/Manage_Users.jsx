...
import { faSearch, faUserPlus , faFilter, faFileExport, faEllipsisV} from '@fortawesome/free-solid-svg-icons';
    ...
    <div className='bg-white justify-center items-center text-center h-screen w-screen relative'>
      <div className='flex flex-row h-12 '>
        <div className='absolute justify-center items-center text-center flex flex-row gap-10 w-[60%] h-12 left-2 '>
          ...
          <input type="search" placeholder='Search' className='border w-[70%] rounded-full p-2' />
          <FontAwesomeIcon icon={faSearch} className='text-blue-700 cursor-pointer' />
        </div>
